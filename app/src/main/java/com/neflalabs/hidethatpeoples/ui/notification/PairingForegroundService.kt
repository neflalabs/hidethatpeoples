package com.neflalabs.hidethatpeoples.ui.notification
...
import com.neflalabs.hidethatpeoples.MainActivity
...
class PairingForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.neflalabs.hidethatpeoples.ACTION_START_PAIRING_SERVICE"
        const val ACTION_SUBMIT = "com.neflalabs.hidethatpeoples.ACTION_SUBMIT_PAIRING"
        const val ACTION_STOP = "com.neflalabs.hidethatpeoples.ACTION_CANCEL_PAIRING"
